...
%Student#: 101089570
%Due date: March 27th, 2022 - midnight 
...
%Creating grating by adding more inclusion: 

epi{1}(125:150,100:95)= c_eps_0*11.3;
epi{1}(125:150,70:140)= c_eps_0*11.3;
epi{1}(125:150,70:60)= c_eps_0*11.3;
...
%Setting more boundaries with bc:
bc{1}.NumS = 1;
